...
public class FormMarcas extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(FormMarcas.class.getName());
    ...
    public FormMarcas() {
        initComponents();
        btnMarcas.setBackground(Color.decode("#015BBB"));
        
        // Se inicializa los controladores
        marcaControl = new MarcaController();
        ...
        tblMarcas.setSelectionMode(SINGLE_SELECTION);
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Detalles de la Marca");
        ...
        txtPais.setFont(new java.awt.Font("Inter SemiBold", 0, 12)); // NOI18N
        ...
        jLabel5.setText("Administra las marcas del inventario");
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (fila == -1) {
            Mensajes.error("Selecciona una marca de la tabla.");
            return;
        }
        ...
        marca.setIdMarca(id);
        boolean activo = (boolean) modelo.getValueAt(fila, 4);
        ...
        boolean confirmacion = Mensajes.confirmacion("¿Está seguro que desea eliminar la marca?", "Eliminación de Categoria");
